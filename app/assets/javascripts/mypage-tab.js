$(function(){
  $('.contener__content__mypage-tab_notice li').click(function(e){
    e.preventDefault();
    var index = $('.contener__content__mypage-tab_notice li').index(this);
    $('.contener__content__mypage-tab_notice li').removeClass('active');
